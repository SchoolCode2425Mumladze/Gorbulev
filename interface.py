...
BACKGROUNDS = ["dark_room.gif", "light_in_the_dark.gif", "stranger.gif", "forest.gif", "pole.gif", "c.gif", "throne.gif", "halls.gif", "throne.gif"]


class Interface:
    def __init__(self, manager):
        self.title = turtle.title("The Choiсe of Life: the Order Empire")
